...
python main.py --ema_baseline_decay=0.9 --shared_initial_step=150 --reward_c=800 --data_path=path of NAS-Bench-101
sleep 2
...
python main.py --ema_baseline_decay=0.95 --shared_initial_step=150 --reward_c=80 --ppl_square=True --data_path=path of NAS-Bench-201
sleep 2
